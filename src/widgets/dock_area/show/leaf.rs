...
const MIN_SQUEEZED_TEXT: f32 = 28.0;
...
const MIN_SQUEEZED_TEXT_ACTIVE: f32 = 2.0 * MIN_SQUEEZED_TEXT;
...
#[cfg(test)]
mod tests {
    use super::{STRIP_MIN_NAME_LENGTH, TabBarFit, fit_strip_names, fit_tab_widths, tab_body_id};
